...
type ServiceOperation[TObjectId object.Identifier, TBizObject any] interface {
...
type ServiceRetrieve[TObjectId object.Identifier, TBizObject any] interface {
...
type ServiceDelete[TObjectId object.Identifier] interface {
